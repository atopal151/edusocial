                        ...
                        children: [
                              ...
                              child: CustomButton(
                                ...
                                backgroundColor: controller.isFollowing.value
                                    ? const Color(0xfff4f4f5) // Unfollow durumunda gri
                                    : const Color(0xFFEF5050), // Follow ve onay bekliyor durumunda kırmızı
                                textColor: controller.isFollowing.value
                                    ? const Color(0xff414751) // Unfollow durumunda koyu gri metin
                                    : const Color(0xffffffff), // Follow ve onay bekliyor durumunda beyaz metin
